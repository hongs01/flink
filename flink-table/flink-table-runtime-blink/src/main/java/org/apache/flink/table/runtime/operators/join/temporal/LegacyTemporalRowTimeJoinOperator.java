...
/**
 * The operator for legacy temporal join (LATERAL TemporalTableFunction(o.rowtime)) on row time, it
 * has limitation that the left input and right input of join contains only INSERT messages.
 *
 * <p>This operator works by keeping on the state collection of probe and build records to process
...
public class LegacyTemporalRowTimeJoinOperator
	...
	public void open() throws Exception {
		...
		// because the legacy temporal join only supports INSERT only left stream
