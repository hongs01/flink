...
/**
 * Tests for {@link RowTimeMiniBatchDeduplicateKeepLastRowFunction}.
 */
@RunWith(Parameterized.class)
public class RowTimeMiniBatchDeduplicateKeepLastRowFunctionTest extends RowTimeDeduplicateFunctionTestBase {

	private long miniBatchSize = 4L;
	private final boolean generateUpdateBefore;
	private final boolean generateInsert;

	public RowTimeMiniBatchDeduplicateKeepLastRowFunctionTest(boolean generateUpdateBefore, boolean generateInsert) {
	...
	public void testRowTimeDeduplicateKeepLastRow() throws Exception {
		RowTimeMiniBatchDeduplicateKeepLastRowFunction func = new RowTimeMiniBatchDeduplicateKeepLastRowFunction(
			inputRowType,
			serializer,
			rowTimeIndex,
