...
/**
 * Tests for {@link RowTimeDeduplicateKeepFirstRowFunction}.
 */
...
public class RowTimeDeduplicateKeepFirstRowFunctionTest extends RowTimeDeduplicateFunctionTestBase {
	...
	public RowTimeDeduplicateKeepFirstRowFunctionTest(boolean generateUpdateBefore, boolean generateInsert) {
	...
	public void testRowTimeDeduplicateKeepFirstRow() throws Exception {
		RowTimeDeduplicateKeepFirstRowFunction func = new RowTimeDeduplicateKeepFirstRowFunction(
			inputRowType,
			serializer,
			rowTimeIndex,
