	...
	static {
		schemaMap.put("catalog_sales", new TpcdsSchema(
			Arrays.asList(
				...
				new Column("cs_quantity", 18, DataTypes.BIGINT()),
		...
		schemaMap.put("catalog_returns", new TpcdsSchema(
			Arrays.asList(
				...
				new Column("cr_return_quantity", 17, DataTypes.BIGINT()),
		...
		schemaMap.put("store_sales", new TpcdsSchema(Arrays.asList(
			...
			new Column("ss_quantity", 10, DataTypes.BIGINT()),
		...
		schemaMap.put("store_returns", new TpcdsSchema(Arrays.asList(
			...
			new Column("sr_return_quantity", 10, DataTypes.BIGINT()),
		...
		schemaMap.put("web_sales", new TpcdsSchema(Arrays.asList(
			...
			new Column("ws_quantity", 18, DataTypes.BIGINT()),
		...
		schemaMap.put("web_returns", new TpcdsSchema(Arrays.asList(
			...
			new Column("wr_return_quantity", 14, DataTypes.BIGINT()),
		...
		schemaMap.put("call_center", new TpcdsSchema(Arrays.asList(
			...
			new Column("cc_employees", 8, DataTypes.BIGINT()),
			new Column("cc_sq_ft", 9, DataTypes.BIGINT()),
			new Column("cc_hours", 10, DataTypes.STRING()),
			new Column("cc_manager", 11, DataTypes.STRING()),
			new Column("cc_mkt_id", 12, DataTypes.BIGINT()),
			...
			new Column("cc_division", 16, DataTypes.BIGINT()),
			new Column("cc_division_name", 17, DataTypes.STRING()),
			new Column("cc_company", 18, DataTypes.BIGINT()),
		...
		schemaMap.put("catalog_page", new TpcdsSchema(Arrays.asList(
			...
			new Column("cp_catalog_number", 5, DataTypes.BIGINT()),
			new Column("cp_catalog_page_number", 6, DataTypes.BIGINT()),
		...
		schemaMap.put("customer", new TpcdsSchema(Arrays.asList(
			...
			new Column("c_birth_day", 11, DataTypes.BIGINT()),
			new Column("c_birth_month", 12, DataTypes.BIGINT()),
			new Column("c_birth_year", 13, DataTypes.BIGINT()),
			...
			new Column("c_last_review_date", 17, DataTypes.BIGINT())
		)));
		...
		schemaMap.put("customer_demographics", new TpcdsSchema(Arrays.asList(
			...
			new Column("cd_purchase_estimate", 4, DataTypes.BIGINT()),
			new Column("cd_credit_rating", 5, DataTypes.STRING()),
			new Column("cd_dep_count", 6, DataTypes.BIGINT()),
			new Column("cd_dep_employed_count", 7, DataTypes.BIGINT()),
			new Column("cd_dep_college_count", 8, DataTypes.BIGINT())
		)));
		schemaMap.put("date_dim", new TpcdsSchema(Arrays.asList(
			...
			new Column("d_month_seq", 3, DataTypes.BIGINT()),
			new Column("d_week_seq", 4, DataTypes.BIGINT()),
			new Column("d_quarter_seq", 5, DataTypes.BIGINT()),
			new Column("d_year", 6, DataTypes.BIGINT()),
			new Column("d_dow", 7, DataTypes.BIGINT()),
			new Column("d_moy", 8, DataTypes.BIGINT()),
			new Column("d_dom", 9, DataTypes.BIGINT()),
			new Column("d_qoy", 10, DataTypes.BIGINT()),
			new Column("d_fy_year", 11, DataTypes.BIGINT()),
			new Column("d_fy_quarter_seq", 12, DataTypes.BIGINT()),
			new Column("d_fy_week_seq", 13, DataTypes.BIGINT()),
			...
			new Column("d_first_dom", 19, DataTypes.BIGINT()),
			new Column("d_last_dom", 20, DataTypes.BIGINT()),
			new Column("d_same_day_ly", 21, DataTypes.BIGINT()),
			new Column("d_same_day_lq", 22, DataTypes.BIGINT()),
		...
		schemaMap.put("household_demographics", new TpcdsSchema(Arrays.asList(
			...
			new Column("hd_dep_count", 3, DataTypes.BIGINT()),
			new Column("hd_vehicle_count", 4, DataTypes.BIGINT())
		)));
		schemaMap.put("income_band", new TpcdsSchema(Arrays.asList(
			new Column("ib_income_band_sk", 0, DataTypes.BIGINT()),
			new Column("ib_lower_bound", 1, DataTypes.BIGINT()),
			new Column("ib_upper_bound", 2, DataTypes.BIGINT())
		)));
		schemaMap.put("item", new TpcdsSchema(Arrays.asList(
			...
			new Column("i_brand_id", 7, DataTypes.BIGINT()),
			new Column("i_brand", 8, DataTypes.STRING()),
			new Column("i_class_id", 9, DataTypes.BIGINT()),
			new Column("i_class", 10, DataTypes.STRING()),
			new Column("i_category_id", 11, DataTypes.BIGINT()),
			new Column("i_category", 12, DataTypes.STRING()),
			new Column("i_manufact_id", 13, DataTypes.BIGINT()),
			...
			new Column("i_manager_id", 20, DataTypes.BIGINT()),
		...
		schemaMap.put("promotion", new TpcdsSchema(Arrays.asList(
			...
			new Column("p_response_target", 6, DataTypes.BIGINT()),
		...
		schemaMap.put("store", new TpcdsSchema(Arrays.asList(
			...
			new Column("s_number_employees", 6, DataTypes.BIGINT()),
			new Column("s_floor_space", 7, DataTypes.BIGINT()),
			new Column("s_hours", 8, DataTypes.STRING()),
			new Column("s_manager", 9, DataTypes.STRING()),
			new Column("s_market_id", 10,  DataTypes.BIGINT()),
			...
			new Column("s_division_id", 14, DataTypes.BIGINT()),
			new Column("s_division_name", 15, DataTypes.STRING()),
			new Column("s_company_id", 16, DataTypes.BIGINT()),
		...
		schemaMap.put("time_dim", new TpcdsSchema(Arrays.asList(
			...
			new Column("t_time", 2, DataTypes.BIGINT()),
			new Column("t_hour", 3, DataTypes.BIGINT()),
			new Column("t_minute", 4, DataTypes.BIGINT()),
			new Column("t_second", 5, DataTypes.BIGINT()),
		...
		schemaMap.put("warehouse", new TpcdsSchema(Arrays.asList(
			...
			new Column("w_warehouse_sq_ft", 3, DataTypes.BIGINT()),
		...
		schemaMap.put("web_page", new TpcdsSchema(Arrays.asList(
			...
			new Column("wp_char_count", 10, DataTypes.BIGINT()),
			new Column("wp_link_count", 11, DataTypes.BIGINT()),
			new Column("wp_image_count", 12, DataTypes.BIGINT()),
			new Column("wp_max_ad_count", 13, DataTypes.BIGINT())
		)));
		schemaMap.put("web_site", new TpcdsSchema(Arrays.asList(
			...
			new Column("web_mkt_id", 9, DataTypes.BIGINT()),
